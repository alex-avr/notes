...
fun ICorChainDsl<FolderContext>.folderValidation(block: ICorChainDsl<FolderContext>.() -> Unit) = chain {
    block()
    title = "Валидация"
...
fun ICorChainDsl<NoteContext>.noteValidation(block: ICorChainDsl<NoteContext>.() -> Unit) = chain {
    block()
    title = "Валидация"
